...
export default function AlumniPage() {
  ...
  return <div>
      <ReuseBanner image="/images/banner/alumni-partners.jpg" title=" Partner With Us - Alumni" subtitle="Reconnect, Mentor, Volunteer" />
      ...
      <section className="bg-gray-50 dark:bg-gray-900 dark:text-gray-100 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-4">
            {alumniCards.slice(0, 5).map((item, idx) => <div key={idx} className=" bg-white dark:bg-gray-800 p-6 shadow hover:shadow-xl transition flex flex-col items-center text-center">
            ...
            <div className="text-white bg-white  shadow-lg flex flex-col justify-center items-center text-center lg:col-span-3 md:col-span-2 col-span-1 min-h-[320px]">
              <div className="relative flex flex-col items-center w-full mx-auto overflow-hidden  md:flex-row-reverse md:max-w-4xl lg:max-w-5xl">
                ...
                <div className="relative w-full h-48 md:h-60 md:w-1/2 group">
                  <Image fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" src="/images/gallery/others/alumni.jpg" alt="Winding mountain road" />

                  {/* MOBILE: always visible | DESKTOP: show on hover */}
                  <a href="https://www.sonatptalumni.org/" target="_blank" rel="noopener noreferrer" className="
    ...
    ">
                ...
                <div className="bg-white text-gray-800 w-full md:w-1/2 h-full flex flex-col justify-center p-6 md:p-8">
                  ...
                  <button onClick={() => setShowAppeal(prev => !prev)} type="button" className="group relative h-12 overflow-hidden rounded-md bg-blue-500 px-6 text-neutral-50 transition hover:bg-blue-600 flex items-center gap-3" aria-label="Toggle Alumni Appeal">
                    {/* 👁 Toggle between View / Hide icons */}
                    {showAppeal ?
                  // Hide Icon (Eye Off)
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 flex-shrink-0">
                        <path d="M6 9l6 6 6-6" />
                      </svg> :
                  // View Icon (Eye)
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 flex-shrink-0">
          ...
          {/* Expanding Alumni Appeal Section */}
            ...
            {showAppeal && <div key="appeal" className="overflow-hidden mt-10">
                <div className="bg-white dark:bg-gray-800 p-8 space-y-6 text-gray-700 dark:text-gray-300">
                  ...
                  <div className="w-full py-10 bg-gray-50 relative overflow-hidden">
                    ...
                    <FaHandsHelping className="absolute inset-0 m-auto text-gray-800 w-32 h-32 opacity-20 pointer-events-none" style={{
                zIndex: 0
              }} />
                  ...
                  <div className="flex flex-wrap gap-6 justify-center">
                    {programs.map((item, idx) => <div key={idx} className="flex flex-col items-center bg-gray-100 text-gray-900  py-1  shadow hover:shadow-lg transition w-60">
