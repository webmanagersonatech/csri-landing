...
export default function NgoPage() {
  ...
  return <div>
      <ReuseBanner image="/images/banner/ngo-partner.jpg" title="Partner With Us - NGO " subtitle="Collaborate for Greater Social Impact" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-16 space-y-16 bg-gray-50 dark:bg-gray-900 px-4 md:px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              description: "Jointly conceptualize training, health, or empowerment initiatives tailored to local needs."
            }, {
              title: "Resource Sharing",
              icon: <FaLightbulb className="text-blue-600 w-12 h-12 mb-4" />,
              description: "Leverage Sona’s academic expertise, trainers, and research while contributing your community networks and insights."
            }, {
              title: "Scale & Outreach",
              icon: <FaGlobe className="text-blue-600 w-12 h-12 mb-4" />,
              description: "Extend program reach through our adopted villages, skill hubs, and strong institutional presence."
            }, {
              title: "Mutual Learning",
              icon: <FaUsers className="text-blue-600 w-12 h-12 mb-4" />,
              description: "Exchange knowledge and best practices, creating stronger, community-driven impact models."
            }, {
              title: "Joint Advocacy",
              icon: <FaUsers className="text-blue-600 w-12 h-12 mb-4" />,
              description: "Amplify voices together for policies that support sustainable livelihoods, education, and inclusion."
            }].map((item, idx) => <div key={idx} className="bg-white p-6 shadow hover:shadow-xl transition flex flex-col items-center text-center ">
              ...
              <div className="lg:col-span-3 md:col-span-1 col-span-1 bg-blue-500/80 text-white  shadow-lg flex flex-col justify-center items-center text-center p-8">
  ...
  ">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="animate-bounce" // tailwind bounce for arrow
                    >
                        <path d="M5 12h14" />
          ...
          {isFormOpen && <div className="fixed inset-0 bg-black/50 flex justify-center items-start overflow-auto z-50 p-4">
              <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl w-full max-w-3xl p-6 md:p-8 relative">
                <button onClick={() => setIsFormOpen(false)} className="absolute top-4 right-4 text-gray-500 hover:text-gray-900 dark:hover:text-white text-2xl font-bold">
                  ×
                </button>
                ...
                <form className="space-y-6 text-gray-700 dark:text-gray-300" onSubmit={handleSubmit}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      {["Education", "Health & Nutrition", "Livelihood & Skill Development", "Women Empowerment", "Environment & Climate Action"].map((item, idx) => <label key={idx} className="flex items-center gap-2">
                      ...
                      {["Children & Youth", "Women & SHGs", "Farmers & Rural Communities", "Urban Poor/Slum Communities", "Tribals/Indigenous Communities"].map((item, idx) => <label key={idx} className="flex items-center gap-2">
                      ...
                      {["Local (single district)", "Regional (multi-district/state-level)", "National"].map((item, idx) => <label key={idx} className="flex items-center gap-2">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        {["Co-Design Programs", "Access to Trainers/Academic Resources", "Joint Implementation in Adopted Villages", "Advocacy & Policy Campaigns"].map((item, idx) => <label key={idx} className="flex items-center gap-2">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        {["Community Networks", "Field Staff", "Volunteers", "Local Knowledge/Best Practices"].map((item, idx) => <label key={idx} className="flex items-center gap-2">
