...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://sonacsri.com/gallery",
  },
  openGraph: {
    title: "Gallery | Sona CSRI – Showcasing Social Impact Initiatives",
    description:
      "Discover photos and highlights from Sona CSRI’s impactful CSR activities and community development programs.",
    url: "https://sonacsri.com/gallery",
    siteName: "Sona CSRI",
    type: "website",
    images: [
      {
        url: "https://sonacsri.com/images/gallery/others/photo-collage.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://sonacsri.com/images/gallery/others/photo-collage.jpg"],
  },
};
