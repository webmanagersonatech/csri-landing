...
const FocusareaSection = () => {
  ...
  return <>
      <ReuseBanner image="https://img.freepik.com/free-photo/cutout-paper-different-family-members-being-together_23-2148699752.jpg?uid=R139790849&ga=GA1.1.898221838.1748329700&semt=ais_hybrid&w=740&q=80" title="Focus Area of Working" subtitle="Where Responsibility Meets Community" />
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900 dark:text-gray-100">
        <div className="max-w-7xl mx-auto ">
          ...
          {/* Animated Content */}
            ...
            <div key={activeTab} className={`grid grid-cols-1 md:grid-cols-2 gap-8 items-center  shadow-lg p-6 
              ...
              <div className="w-full h-64 relative  overflow-hidden shadow-md">
                <Image src={activeContent?.image || ""} alt={activeContent?.label || ""} fill className="object-cover" />
              </div>
              ...
              <div className="text-justify space-y-4 text-gray-700 dark:text-gray-200">
                ...
                {activeContent?.content.split("\n").map((line, i) => <div key={i} className="flex items-start gap-2">
                    {/* Show icon only for lines that start with "•" */}
                    {line.trim().startsWith("•") ? <MdStar className="mt-1 text-blue-500/70 flex-shrink-0" /> : null}
