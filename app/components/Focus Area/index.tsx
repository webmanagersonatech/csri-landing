            ...
            {programCategories.map((program, idx) => <StaggerItem key={idx} className="bg-white shadow-lg hover:shadow-xl transition-shadow duration-500 flex flex-col overflow-hidden">
                ...
                <div className="p-5 flex flex-col flex-1">
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button onClick={() => router.push(`${program.slug}`)} className="hover:bg-blue-500 group relative inline-flex h-12 w-12 items-center justify-center overflow-hidden rounded-full bg-blue-600 font-medium text-neutral-200">
