...
const CSRITeam = () => {
  ...
  return <section className="bg-gradient-to-r from-gray-100 via-white to-white">
      <div className="
        ...
        <div className="flex-1 flex">
          ...
          <div className="relative w-full h-full min-h-[300px] lg:min-h-[400px]">
            <Image src="/images/home/Our-Team-Believes-in-Empowering-Communities.webp" alt="CSRI Team at Work" fill className="
                object-cover 
                rounded-xl 
                shadow-lg
              " />
