...
export default class Partners extends Component {
  render() {
    return <div id="partners-section" className=" py-8">

        {/* HEADER */}
        <div className='mx-auto max-w-2xl lg:max-w-7xl text-center sm:py-4 lg:px-8'>
        ...
        <Slider {...settings} className="mt-10">
          {partnerData.map((item, i) => <div key={i}>
              <div className='bg-white m-3 py-14 text-center shadow-xl rounded-3xl relative'>
                <Image src={item.imgSrc} alt={item.title} width={182} height={182} className="inline-block m-auto rounded-full" />
