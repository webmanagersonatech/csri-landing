...
export default class CSRIEventsCarousel extends Component {
  render() {
    ...
    return <div className="bg-lightgrey py-12" id="events-section">
                <div className="mx-auto max-w-7xl sm:py-4 lg:px-8">
                    ...
                    <Slider {...settings} className="px-4">
                        {eventsData.map((event, i) => <div key={i} className="px-2" // <-- This adds horizontal gap for each card
          >
                                <div className="bg-white shadow-lg rounded-3xl overflow-hidden w-full">
                                    <div className="relative w-full h-60">
                                        <Image src={event.imgSrc} alt={event.title} fill className="object-cover" />
                                        <Link href="/">
