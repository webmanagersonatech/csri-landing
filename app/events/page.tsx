...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: "https://sonacsri.com/events",
    },
    openGraph: {
        title: "Events | Sona CSRI – Social Impact & Community Engagement",
        description:
            "Explore recent CSR events, awareness drives, and sustainability initiatives by Sona CSRI.",
        url: "https://sonacsri.com/events",
        siteName: "Sona CSRI",
        type: "website",
        images: [
            {
                url: "https://sonacsri.com/images/banner/events-banner.jpg",
                width: 1200,
                height: 630,
    ...
    twitter: {
        ...
        images: ["https://sonacsri.com/images/banner/events-banner.jpg"],
    },
};
