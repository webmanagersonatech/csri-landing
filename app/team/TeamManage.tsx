...
const Teammanage = () => {
  ...
  return <div className=" bg-gray-50 dark:bg-gray-900 dark:text-gray-100">
      <ReuseBanner image="/images/team/team-background.jpeg" title="Team" subtitle="Guiding the Vision for Impactful Change" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {profilesx.map((profile: any) => <div key={profile.id} className="max-w-sm bg-white dark:bg-gray-900 rounded-lg overflow-hidden shadow-lg">
                <div className="border-b px-2 py-6">
                  <div className="text-center">
                    <Image className="h-32 w-32 rounded-full border-4 border-white dark:border-gray-800 mx-auto" src={profile.image} alt={profile.name} width={128} height={128} />
                    <div className="py-2">
                  ...
                  <div className="flex gap-2 px-2">
                    <button onClick={() => setSelectedProfile(profile)} className="group relative inline-flex w-full items-center justify-start overflow-hidden rounded-xl bg-blue-500 px-8 py-2 font-medium transition-all">
