...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://sonacsri.com/contact",
  },
  openGraph: {
    title: "Contact | Sona CSRI – Center for Social Responsibility Initiatives",
    description:
    ...
    url: "https://sonacsri.com/contact",
    siteName: "Sona CSRI",
    images: [
      {
        url: "https://sonacsri.com/images/og-contact.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://sonacsri.com/images/og-contact.jpg"],
  },
  robots: {
    index: true,
    follow: true,
